...
var $author$project$Main$ShowTime = function (a) {
	return {$: 'ShowTime', a: a};
};
...
var $author$project$Main$subscriptions = function (model) {
	return A2($elm$time$Time$every, 1000, $author$project$Main$ShowTime);
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('welcomeTitle')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(welcomeTitle)
						])),
					A2(
					$elm$html$Html$a,
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$class('btn buttonMore')
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('#about'),
							$elm$html$Html$Attributes$class('downButton')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('fa fa-angle-double-down')
								]),
							_List_Nil)
						]))
				]));
...
var $author$project$Main$navbarList = function (logoName) {
	var linkList = _List_fromArray(
		['home', 'about', 'skills', 'portfolio', 'contact']);
	var navigationList = A2(
		$elm$core$List$map,
		function (a) {
			return A2(
				$elm$html$Html$li,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm_community$string_extra$String$Extra$toTitleCase(a))
							]))
					]));
		},
		linkList);
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('menu touch')
			]),
		A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									$elm_community$string_extra$String$Extra$toTitleCase(logoName))
								]))
						]))
				]),
			navigationList));
...
var $author$project$Main$navbarView = function (logoName) {
	return A2(
		$elm$html$Html$nav,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$id('checkbox-menu')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$label,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$for('checkbox-menu')
					]),
				_List_fromArray(
					[
						$author$project$Main$navbarList(logoName),
						A2(
						$elm$html$Html$span,
						_List_fromArray(
							[
...
var $author$project$Main$titleShadow = function (title) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
				...
				[
					...
					$elm_community$string_extra$String$Extra$decapitalize(
						$elm_community$string_extra$String$Extra$camelize(
							A2($elm_community$string_extra$String$Extra$unsurround, '', title) + 'Title')))
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					$elm_community$string_extra$String$Extra$decapitalize(
						$elm_community$string_extra$String$Extra$camelize(
							A2($elm_community$string_extra$String$Extra$unsurround, '', title) + 'TitleShadow')))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(title)
